...
import {safeCall} from '../../common/utils/safe-call';
...
import {removeAuthToken, saveAuthToken} from '../../common/utils/auth';
...
function* doFetchUserData() {
    const {authenticated, user}: AppState = yield select((state: RootState) => state.app);
