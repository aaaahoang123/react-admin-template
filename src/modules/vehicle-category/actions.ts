...
export const vehicleCategoriesListLoaded = createAction<VehicleCategory[], VehicleCategoryParams>(VEHICLE_CATEGORY_LIST_LOADED);
...
export const vehicleCategoryFormChangeByRestData = createAction<VehicleCategory>(VEHICLE_CATEGORY_FORM_CHANGE_BY_REST_DATA);
